...
-- Records of limit
-- ----------------------------
INSERT INTO `limit` VALUES (1, '1年以下');
INSERT INTO `limit` VALUES (2, '1-2年');
INSERT INTO `limit` VALUES (3, '3-5年');
INSERT INTO `limit` VALUES (4, '6-10年');
INSERT INTO `limit` VALUES (5, '10年以上');
...
-- ----------------------------
INSERT INTO `personage` VALUES (1, 'John', '123456', '13888888888', 'john@example.com', '2022-01-01');
INSERT INTO `personage` VALUES (2, 'Mary', '654321', '13999999999', 'mary@example.com', '2022-02-01');
INSERT INTO `personage` VALUES (3, 'Tom', 'abcdef', '13666666666', 'tom@example.com', '2022-03-01');
INSERT INTO `personage` VALUES (4, '张三', '123456', '13800000000', 'zhangsan@example.com', '2022-01-01');
INSERT INTO `personage` VALUES (5, '李四', '654321', '13911111111', 'lisi@example.com', '2022-01-02');
INSERT INTO `personage` VALUES (6, '王五', 'abcdef', '13622222222', 'wangwu@example.com', '2022-01-03');
INSERT INTO `personage` VALUES (7, '赵六', 'edcba', '13533333333', 'zhaoliu@example.com', '2022-01-04');
INSERT INTO `personage` VALUES (8, '刘七', 'qweasd', '18044444444', 'liuqi@example.com', '2022-01-05');
INSERT INTO `personage` VALUES (9, '朱八', 'poiuyt', '18555555555', 'zhuba@example.com', '2022-01-06');
INSERT INTO `personage` VALUES (10, '陈九', 'asdfgh', '18866666666', 'chenjiu@example.com', '2022-01-07');
INSERT INTO `personage` VALUES (11, '周十', 'lkjhgf', '15677777777', 'zhoushi@example.com', '2022-01-08');
INSERT INTO `personage` VALUES (12, '吴十一', 'mnbvcx', '15188888888', 'wushiyi@example.com', '2022-01-09');
INSERT INTO `personage` VALUES (13, '郑十二', 'zxcvbn', '13999999999', 'zhengershier@example.com', '2022-01-10');
...
CREATE TABLE `position`  (
  ...
  `position` varchar(10) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '招聘职位',
  ...
  `limit` varchar(5) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '工作年限',
...
-- Records of position
-- ----------------------------
INSERT INTO `position` VALUES (1, 1, 'PHP开发工程师', '技术', '北京', 3, 12000, '计算机科学', '负责公司产品的PHP开发和维护，熟悉LAMP架构，有良好的编程习惯和源码阅读能力。', '本科及以上', '1年以上', 2147483647, '国企', '张女士');
INSERT INTO `position` VALUES (2, 2, '电商运营专员', '运营', '上海', 5, 10000, '市场营销', '负责公司招商、网店运营和客户服务等工作，具备一定的项目管理能力和团队合作精神。', '本科及以上', '2年以上', 2147483647, '外资', '王女士');
INSERT INTO `position` VALUES (3, 3, '影视制片人', '文化传媒', '广州', 2, 15000, '影视制作', '负责影视节目策划、制作和推广等工作，具有较强的创意能力和团队协作精神。', '本科及以上', '3年以上', 2147483647, '已上市', '赵先生');
INSERT INTO `position` VALUES (4, 4, '投资顾问', '金融', '深圳', 10, 20000, '经济学', '负责为客户提供理财、投资等方面的咨询服务，具备一定的分析和决策能力。', '本科及以上', '5年以上', 2147483647, '合资', '李先生');
INSERT INTO `position` VALUES (5, 4, '机器学习工程师', '人工智能', '杭州', 3, 18000, '计算机科学', '负责公司智能化项目的研发和实现，具备较强的算法和编程能力，有深度学习经验者优先。', '硕士及以上', '2年以上', 2147483647, '民营', '张先生');
INSERT INTO `position` VALUES (6, 5, 'UI设计师', '设计', '成都', 2, 10000, '平面设计', '负责公司产品UI设计和视觉效果设计，熟练使用设计软件如 Photoshop、Sketch 等，有良好的审美能力和设计思路。', '本科及以上', '1年以上', 2147483647, '上市公司', '朱先生');
INSERT INTO `position` VALUES (7, 3, '运动教练', '健身', '广州', 5, 7000, '体育教育', '负责公司的健身培训业务，具有相关的专业知识和经验，有良好的沟通能力和服务意识。', '大专及以上', '2年以上', 2147483647, '中外合资', '朱女士');
INSERT INTO `position` VALUES (8, 2, '客服专员', '客服', '北京', 3, 8000, '英语', '负责公司产品的客户服务，具有良好的沟通能力和服务意识，英语口语流利者优先。', '本科及以上', '1年以上', 2147483647, '外资', '袁先生');
INSERT INTO `position` VALUES (9, 4, '证券分析师', '金融', '南京', 2, 20000, '金融学', '负责为客户提供证券投资方面的分析和建议，具备一定的金融理论和实践经验。', '硕士及以上', '5年以上', 2147483647, '民营', '张女士');
INSERT INTO `position` VALUES (10, 1, 'Android开发工', '技术', '深圳', 3, 15000, '计算机科学', '负责公司产品的Android端开发和维护，熟悉Android SDK、Java 开发、Android 开发模式，有良好的编程习惯和源码阅读能力。', '本科及以上', '3年以上', 2147483647, '国企', '袁先生');
INSERT INTO `position` VALUES (11, 2, '京东店长', '电商', '上海', 2, 12000, '市场营销', '负责公司京东店铺的运营和管理，具有相关的电商运营和团队管理经验。', '本科及以上', '2年以上', 2147483647, '外资', '朱女士');
INSERT INTO `position` VALUES (12, 3, '新媒体编辑', '传媒', '北京', 5, 8000, '新闻传播', '负责公司新媒体平台的内容策划和编辑，具备较强的新闻敏感性和文字表达能力，熟悉微信公众号运营。', '本科及以上', '1年以上', 2147483647, '已上市', '袁先生');
INSERT INTO `position` VALUES (13, 1, '前端开发工程师', '技术', '广州', 3, 13000, '计算机科学', '负责公司产品的前端开发和维护，熟悉JavaScript、CSS、HTML 等相关技术，有良好的编程习惯和源码阅读能力。', '本科及以上', '2年以上', 2147483647, '国企', '彭女士');
INSERT INTO `position` VALUES (14, 4, '银行营销经理', '金融', '重庆', 2, 18000, '市场营销', '负责公司银行业务的营销和销售，具备一定的客户管理和谈判能力，有银行从业资格者优先。', '本科及以上', '3年以上', 2147483647, '合资', '张女士');
INSERT INTO `position` VALUES (15, 5, '软件测试工程师', '技术', '武汉', 3, 11000, '计算机科学', '负责公司产品的软件测试和质量保证，熟悉软件测试的各种方法和工具，有良好的问题分析和解决能力。', '本科及以上', '1年以上', 2147483647, '上市公司', '王先生');
INSERT INTO `position` VALUES (16, 2, '市场推广专员', '营销', '成都', 5, 9000, '市场营销', '负责公司产品的市场推广和宣传，具备一定的营销策划和执行能力，有互联网行业经验者优先。', '本科及以上', '2年以上', 2147483647, '外资', '朱女士');
INSERT INTO `position` VALUES (17, 3, '音乐编曲师', '文化娱乐', '北京', 2, 12000, '音乐制作', '负责公司音乐制作和编曲等工作，具有相关音乐专业知识和经验，熟练操作各类音乐软件。', '本科及以上', '3年以上', 2147483647, '已上市', '彭先生');
INSERT INTO `position` VALUES (18, 4, '税务经理', '财务', '上海', 2, 25000, '财务管理', '负责公司税务申报和税务筹划工作，具备相关财务和税务专业知识和经验，有注册会计师等专业资格者优先。', '本科及以上', '5年以上', 2147483647, '民营', '王女士');
INSERT INTO `position` VALUES (19, 1, '数据挖掘工程师', '人工智能', '深圳', 3, 18000, '计算机科学', '负责公司数据挖掘和分析工作，具备相关的统计和机器学习知识，熟练使用各类数据分析软件。', '硕士及以上', '2年以上', 2147483647, '国企', '彭先生');
INSERT INTO `position` VALUES (20, 5, '产品经理', '产品', '北京', 2, 20000, '市场营销', '负责公司产品的规划和策划工作，具有较强的市场敏感性和产品设计能力，有互联网行业经验者优先。', '本科及以上', '3年以上', 2147483647, '上市公司', '朱女士');
INSERT INTO `position` VALUES (21, 2, '人力资源专员', '人力资源', '杭州', 5, 8000, '人力资源管理', '负责公司的人力资源招聘和管理工作，具有相关的人力资源管理专业知识和经验，良好的沟通和协调能力。', '本科及以上', '1年以上', 2147483647, '外资', '王女士');
INSERT INTO `position` VALUES (22, 3, '平面设计师', '设计', '广州', 2, 10000, '平面设计', '负责公司平面设计和视觉效果设计，熟练使用设计软件如 Photoshop、Illustrator 等，有良好的审美能力和设计思路。', '本科及以上', '1年以上', 2147483647, '已上市', '彭先生');
INSERT INTO `position` VALUES (23, 4, '风控经理', '金融', '深圳', 2, 22000, '金融学', '负责公司风险管理和控制工作，具备相关的金融理论和实践经验，有征信分析、风险评估等方面经验者优先。', '硕士及以上', '5年以上', 2147483647, '民营', '王女士');
INSERT INTO `position` VALUES (24, 4, '技术支持工程师', '技术', '武汉', 3, 9000, '计算机科学', '负责公司产品技术支持和问题处理工作，具备一定的技术储备和问题解决能力，有良好的客户服务态度。', '本科及以上', '1年以上', 2147483647, '上市公司', '彭先生');
INSERT INTO `position` VALUES (25, 1, '电子商务专员', '电商', '广州', 2, 10000, '市场营销', '负责公司电子商务平台营销和运营工作，具有一定的电商行业知识和市场策划能力，熟悉电子商务平台操作。', '本科及以上', '1年以上', 2147483647, '国企', '王女士');
...
CREATE TABLE `qualification`  (
  ...
  CONSTRAINT `fk_qualification_position_id` FOREIGN KEY (`id`) REFERENCES `position` (`id`) ON DELETE CASCADE ON UPDATE RESTRICT
...
CREATE TABLE `resume`  (
  `id` int(9) NOT NULL COMMENT '需要关联到个人注册列表的id',
  `name` varchar(20) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '姓名',
  `sex` char(1) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL COMMENT '性别 0-女 1-男',
  ...
  CONSTRAINT `id` FOREIGN KEY (`id`) REFERENCES `personage` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Compact;

-- ----------------------------
-- Records of resume
-- ----------------------------
INSERT INTO `resume` VALUES (1, '张三', '1', '1990-01-01', '计算机科学', '本科', '3', '山东', '软件开发工程师', '10k', '就职于某知名互联网公司，参与多个大型项目的前后端开发；熟悉 Java、Vue.js 等技术', 2147483647, 'zhangsan@example.com');
INSERT INTO `resume` VALUES (2, '李四', '0', '1992-05-12', '会计学', '本科', '2', '江苏', '财务人员', '8k', '就职于某知名集团公司，主要从事财务报表编制和核对等工作', 2147483647, 'lisi@example.com');
INSERT INTO `resume` VALUES (3, '王五', '1', '1991-09-08', '市场营销', '本科', '4', '广东', '市场推广', '12k', '就职于某知名互联网公司，担任市场推广经理，负责公司品牌宣传和产品推广等工作', 2147483647, 'wangwu@example.com');
INSERT INTO `resume` VALUES (4, '赵六', '0', '2000-02-28', '计算机科学', '本科', '3', '北京', '软件开发', '10k', '哈布垃圾公司', 1333333333, 'qweqwe@163.com');
INSERT INTO `resume` VALUES (5, '请问', '1', '2002-03-02', '计算机软件', '本科', '2', '山东', '软件开发', '10k', '待业', 2147483647, 'qweqwe@143.com');
INSERT INTO `resume` VALUES (6, '请问请问呢', '1', '2002-03-04', '计算机软件', '本科', '2', '上海', '软件开发', '10k', '待业', 2147483647, 'qweqwe@143.com');
INSERT INTO `resume` VALUES (7, '请问请问呢', '0', '2002-03-04', '传销头子', '本科', '2', '上海', '软件开发', '10k', '待业', 2147483647, 'qweqwe@143.com');
