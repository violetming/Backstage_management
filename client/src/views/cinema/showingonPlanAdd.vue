<template>
  <div>
    为
    <b style='color:#409EFF'>{{roomInfo.cinema_name}}</b>的
    <b style='color:#409EFF'>{{roomInfo.cinema_room_name}}（{{roomInfo.cinema_room_type}}）</b>
    添加拍片计划
          ...
          if(res.data.code==200){
            ...
            this.$notify({
              ...
              message:`
                ...
                ${this.roomInfo.cinema_room_type}
                </p>
