<template>
  <div>
    ...
    >
      ...
      <el-form-item>
        <el-button type="primary" @click="submit">修改电影院</el-button>
      </el-form-item>
    </el-form>
  </div>
</template>
...
export default {
  ...
  methods: {
    submit() {
      this.$refs["form"].validate((valid) => {
        if (valid) {
          ...
          httpApi.cinemaapi.update(this.form).then((res) => {
    ...
    fillings(){
      ...
      console.log('@',id);
      httpApi.cinemaapi.quwey1({id}).then(res=>{
        console.log('@@@@@@@@',res);
