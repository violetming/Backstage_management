  ...
  <div>
    ...
    <el-form ref="form" :model="form" :rules="rules" label-width="100px" style="width: 600px">
      ...
      <el-form-item label="电影名称" prop='title'>
        <el-input placeholder="输入电影名称" v-model='form.title'></el-input>
      </el-form-item>
      ...
      <el-form-item label="电影主演" prop='starActor'>
        <!-- :remote-method="remoteMethod" 这个函数是  填写字段之后触发请求 -->
        <el-select
      ...
      <el-form-item label="电影时长" prop='duration'>
        ...
        v-model="form.duration"
         placeholder="输入电影时长（分钟）"></el-input>
      </el-form-item>
...
export default {
  ...
  data() {
    return {
      ...
      types:[],  //绑定电影类别数组
      loading:false, //表示selec是否在异步加载数据中
      actors:[],  //绑定演员数组
    }
  },
  mounted(){
