    ...
    <el-table v-if="moviesData" :data="moviesData.result">
      ...
      <el-table-column width="200px" label="操作">
          <template slot-scope="scope">
            ...
            <el-button @click='$router.push(`/home/movie-update/${scope.row.id}`)' size="small" type="warning" icon="el-icon-edit" circle></el-button>
            <el-button size="small" type="danger" icon="el-icon-delete" circle @click="del(scope.row.id)"></el-button>
          </template>
      </el-table-column>
    </el-table>
...
export default { 
  ...
  methods: {
    ...
    listMovies(){
      ...
      console.log(params)
      httpApi.movieApi.query(params).then(res=>{
